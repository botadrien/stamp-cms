/**
 * Track E (voir docs/plan-puck-ssg.md) : générateur de sitemap.xml en JS pur, en
 * remplacement du sitemap intégré que Zola générait automatiquement.
 *
...
// api.js/site-builder.js) et url commence toujours par "/" (page standalone/article, voir
