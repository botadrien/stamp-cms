/**
 * Track B (voir docs/plan-puck-ssg.md) : resolveProps, la fonction unique utilisée à
 * l'identique en preview et en publication pour remplacer les bindings d'un arbre de
 * props Puck par de vraies valeurs. Voir ssg-src/types.js pour la forme de Context et
 * des BindDescriptor.
 */
...
/**
 * Résout un CollectionBindDescriptor (voir ssg-src/types.js) en tableau de ContentItem :
 * lit `context.collections[descriptor.from]`, trie et limite selon le descripteur.
 * @param {import("./types.js").CollectionBindDescriptor} descriptor
 ...
 * simple dans `context`.
 * @type {import("./types.js").ResolveProps}
 */
