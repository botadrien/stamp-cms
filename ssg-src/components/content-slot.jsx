 ...
 * puck.json`, voir ssg-src/default-templates.js). Remplace l'ancien "PageContent", qui
 ...
 * ssg-src/template-merge.js juste avant le rendu (voir buildSite() dans renderer.jsx) —
