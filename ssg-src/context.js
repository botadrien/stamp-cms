// Construit l'objet Context (voir ssg-src/types.js) à partir des Collections produites
// par content-loader.js et des infos de site (titre, base_url, nav). La nav reprend
// exactement la logique de buildConfigToml() dans site-builder.js — "Accueil" + une
...
// site-builder.js, ou l'URL de pages du fournisseur sinon) est calculé par l'appelant
