/**
 * Champ Puck "custom" pour choisir un binding (voir app/ssg/types.js: BindDescriptor)
 * via un sélecteur plutôt qu'un texte libre à
 ...
 * app/ssg/types.js). `options.paths` restreint la liste des chemins proposés en mode
