/**
 * Composant Puck "Nav". Boucle sur une collection (liste de liens), donc utilise le
 * champ binding (voir app/puck/fields/binding-field.jsx) pour choisir sa source :
 * `site.nav` par défaut (voir buildNav() dans app/ssg/context.js), ou une collection
 ...
 * via `resolveProps`/`useSsgContext` (voir app/puck/ssg-context.js), sans passer par le
 * Repeater. Ce que le Repeater apporte en plus (slot personnalisable par item) sert à
 * ArticleTeaser (voir app/puck/components/article-teaser.jsx), pas à la nav.
 */
...
// item.url est racine-relatif au contenu (voir resolveHref() dans app/ssg/context.js) —
