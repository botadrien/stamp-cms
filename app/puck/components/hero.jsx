/**
 * Composant Puck "Hero", statique — texte tapé en dur par l'auteur·ice, pas de champ
 * binding (les composants statiques hero/CTA/grille n'ont besoin de rien d'autre).
 * Style en custom properties CSS + style inline, pas de Sass.
 *
 * Défauts visuels inspirés de https://demo.puckeditor.com/ (voir app/puck/design-tokens.js) :
