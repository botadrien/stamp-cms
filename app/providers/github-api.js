// Petit client pour l'API GitHub — miroir de ForgejoApi (app/providers/api.js), même surface de
// méthodes pour que app/app.js/app/site/site-builder.js appellent l'un ou l'autre sans distinction
// (voir app/providers/providers.js pour le choix du bon client selon le fournisseur connecté).
...
// decodeBase64Utf8 dans app/site/site-builder.js, qui suppose du texte UTF-8) — utilisé pour les
...
class GitHubApi {
  ...
  // pose le topic SITE_TOPIC (voir app/providers/api.js) — comme Forgejo, l'API de création de dépôt de
  ...
  // chaque publication (rebuildAndPublishSite() dans app/site/site-builder.js) : sans ça (`base_tree`
