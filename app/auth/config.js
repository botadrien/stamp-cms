...
// Les tests e2e (voir tests/) injectent window.__CMS_TEST_CONFIG__ avant ce script pour
// pointer vers l'instance Forgejo locale plutôt que Codeberg — voir tests/seed.mjs.
const CONFIG = window.__CMS_TEST_CONFIG__ || {
  ...
  // Domaine où Codeberg Pages sert les sites publiés (voir app/providers/api.js:pagesUrl) —
  ...
  // OAuth2 + PKCE en un clic que Codeberg — voir app/providers/providers.js et app/providers/gitlab-api.js.
