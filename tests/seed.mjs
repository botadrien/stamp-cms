...
// Écrit le résultat dans tests/.seed.json, lu ensuite par les tests Playwright.
...
async function main() {
  ...
  // renderDashboard() (app/app.js) ne liste que les dépôts portant ce topic (voir SITE_TOPIC,
  // app/providers/api.js) — sans lui, ce dépôt de test n'apparaîtrait jamais dans "Tes sites".
  ...
  console.log("Seed écrit dans tests/.seed.json ✓");
}
