...
//
// Suite volontairement séparée de e2e/tests/ (voir playwright.gitlab.config.mjs et
...
test.beforeEach(async ({ page }) => {
  // Fait pointer config.js vers l'instance GitLab locale plutôt que gitlab.com.
