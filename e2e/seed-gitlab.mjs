...
// de test, une branche "pages". Écrit le résultat dans e2e/.seed-gitlab.json, lu ensuite
// par les tests Playwright de e2e/tests-gitlab/.
//
...
async function main() {
  ...
  console.log("Seed écrit dans e2e/.seed-gitlab.json ✓");
}
